...
This project is indexed by GitNexus as **CLI-Manager** (19714 symbols, 39261 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
