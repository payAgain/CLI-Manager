...
This project is indexed by GitNexus as **CLI-Manager** (19046 symbols, 37794 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
