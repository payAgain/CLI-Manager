...
This project is indexed by GitNexus as **CLI-Manager** (12745 symbols, 24369 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
