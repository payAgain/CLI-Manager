...
This project is indexed by GitNexus as **CLI-Manager** (11747 symbols, 22343 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
