...
This project is indexed by GitNexus as **CLI-Manager** (15062 symbols, 29253 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
